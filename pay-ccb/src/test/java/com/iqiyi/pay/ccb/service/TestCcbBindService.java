...
public class TestCcbBindService {

	private CcbBindService cbs = new CcbBindService();
	...
	public void test() {
		...
		params.put("sms_code", "abcdefd");
		Map<String,Object> result = cbs.service(params, key, secretKey);
